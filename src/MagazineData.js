...
export const STATIC_CONTENT_LIBRARY = {
  ...
  "Fotossíntese Artificial": {
    ...
    additionalImages: [
        ...
        { url: "https://image.pollinations.ai/prompt/solar%20fuel%20production%20plant%20desert?width=800&height=600&nologo=true", caption: "Usinas solares que produzem combustível líquido, não apenas eletricidade." }
    ],
    content: `As plantas fazem algo milagroso: usam luz solar para quebrar água e CO2 e transformá-los em açúcar (energia armazenada). A Fotossíntese Artificial tenta replicar e melhorar esse processo para criar combustíveis limpos. A ideia é usar semicondutores e catalisadores para capturar a luz do sol e usar essa energia para quebrar moléculas de água (H2O) em Hidrogênio e Oxigênio.

    O "Santo Graal" é ir além e capturar também o CO2 da atmosfera, combinando-o com o Hidrogênio para criar hidrocarbonetos líquidos (como metanol ou gasolina sintética). Isso criaria um ciclo de carbono neutro: você queima o combustível no carro, libera CO2, e a "folha artificial" captura esse mesmo CO2 de volta para fazer mais combustível.

    O desafio é encontrar catalisadores que sejam baratos, eficientes e duráveis. A natureza usa enzimas frágeis que se reparam constantemente. Nós precisamos de materiais robustos. Avanços recentes com "folhas biônicas" que usam bactérias geneticamente modificadas junto com painéis solares já atingiram eficiências de conversão de energia solar para biomassa de 10%, muito superior ao 1% típico das plantas.`
  },
...
/**
 * 🎨 TEMAS DE CAPA (MAGAZINE COVERS) - Com Imagens Pollinations.ai BLINDADAS
 */
